...
IDLE_SPREAD_FACTOR = 3.5    # ...this many times further while the group sits, sleeps or drinks...
...
CAREER_DISTRICTS = (1, 2, 4)  # like the books: these districts' tributes are likelier to team up...
CAREER_ALLIANCE_BONUS = 1.4   # ...their chance to ally with each other is multiplied by this
...
CAMERA_STARVE_THRESHOLD = 5 # shows a tribute whose hunger or thirst is below this (about to die)...
CAMERA_STARVE_LINGER_SECONDS = 0.3  # ...and stays this long after it dies
